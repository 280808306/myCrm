...
<body>
	<table id="customerTraceHistory-datagrid" class="easyui-datagrid"
		url="/customerTraceHistory/list" title="客户跟进历史管理" fit="true"
		border="false" fitColumns="true" singleSelect="true" rownumbers="true"
		...
		<thead>
			<tr>
				...
				<th field="traceType" width="1" formatter="objectFormatter">跟进方式</th>
				<th field="traceTimeFormat" width="1">跟进时间</th>
			</tr>
		</thead>
	</table>
	...
	<div id="customerTraceHistory-dlg" class="easyui-dialog"
		...
		title="添加客户跟进历史对话框" modal="true"
		buttons="#customerTraceHistory-dlg-buttons">
		<div class="ftitle">客户跟进历史详情</div>
		<form id="customerTraceHistory-form" method="post" novalidate>
			<input name="id" type="hidden">
			<div class="fitem">
				<label>跟进客户:</label> <select name="customer.id"
			...
			<div class="fitem">
				<label>跟进人:</label> <select name="traceUser.id"
					class="easyui-combogrid" style="width: 155px"
					data-options="
 			            panelWidth: 300, 
 			            idField: 'id', 
			...
			<div class="fitem">
				<label>跟进效果:</label> <select class="easyui-combobox"
					name="traceResult" style="width: 155px" fitColumns="true">
...
<!-- 			<div class="fitem"> -->
<!-- 				<label>跟进时间:</label> <input name="traceTime" -->
<!-- 					class="easyui-datebox" parser="timeParser"></input> -->
<!-- 			</div> -->
		</form>
	</div>
	<!-- 对话框按钮 -->
...
<!-- 			<div class="fitem"> -->
<!-- 				<label>客户姓名:</label> <input name="cusname" class="easyui-textbox"> -->
<!-- 			</div> -->
			<div class="fitem">
				<label>跟进效果:</label> <select class="easyui-combobox"
					name="traceResult" style="width: 155px" fitColumns="true">
			...
			<div class="fitem">
				<label>跟进主题:</label> <input name="title" class="easyui-textbox">
			</div>
			<div class="fitem">
				<label>备注:</label> <input name="remark" class="easyui-textbox">
			</div>
			<div class="fitem">
				<label>跟进人:</label> <select name="traceUserId"
					class="easyui-combogrid" style="width: 155px"
					data-options="
 			            panelWidth: 300, 
 			            idField: 'id', 
